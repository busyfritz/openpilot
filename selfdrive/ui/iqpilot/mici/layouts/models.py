...
class ModelsLayoutMici(NavWidget):
  ...
  def _select_default(self):
    pop_bundle = next((b for b in self.model_manager.availableBundles if b.internalName == "Pop!"), None)
    if pop_bundle:
      ui_state.params.put("ModelManager_DownloadIndex", pop_bundle.index)
    self._reset_main_view()
