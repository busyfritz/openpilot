...
class CarState(CarStateBase, CarStateExt):
  ...
  # Vehicle speed
    ...
    if Bus.adas in can_parsers:
      ...
      self.das_body_controls = copy.copy(cp_vehicle.vl["DAS_bodyControls"])
  ...
  def get_can_parsers(CP, CP_IQ):
    ...
    if Bus.adas in DBC[CP.carFingerprint]:
      parsers[Bus.adas] = CANParser(DBC[CP.carFingerprint][Bus.adas], [("DAS_bodyControls", 0)], CANBUS.autopilot_party)
    return parsers
