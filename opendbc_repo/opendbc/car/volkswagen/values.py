...
from opendbc.car.volkswagen.meb.values import (
  VolkswagenMEBPlatformConfig,
  VolkswagenMQBevoPlatformConfig,
  configure_meb_ccp,
)
...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      configure_meb_ccp(self, bool(CP.flags & VolkswagenFlags.ALT_GEAR), can_define, Button)
...
# VolkswagenMEBPlatformConfig and VolkswagenMQBevoPlatformConfig are defined in
# opendbc.car.volkswagen.meb.values and imported at the top of this module.
...
class CAR(Platforms):
  ...
  VOLKSWAGEN_ID4_MK1 = VolkswagenMEBPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=2224, wheelbase=2.77, steerRatio=15.6),
    chassis_codes={"E2"},
  ...
  AUDI_Q4_MK1 = VolkswagenMEBPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=1965, wheelbase=2.764, steerRatio=15.6),
    chassis_codes={"FZ"},
  ...
  SKODA_ENYAQ_MK1 = VolkswagenMEBPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=1965, wheelbase=2.77, steerRatio=15.6),
    chassis_codes={"NY"},
    model_years={"M", "N", "P"},
    wmis={WMI.SKODA},
  )
