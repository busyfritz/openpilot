...
class ModelState(ModelStateBase):
  ...
  def run(self, bufs: dict[str, VisionBuf], transforms: dict[str, np.ndarray],
    ...
    if hasattr(self.model_runner, 'run_vision'):
      vision_output = self.model_runner.run_vision()
      self.temporal_buffers['features_buffer'][0, :-1] = self.temporal_buffers['features_buffer'][0, 1:]
      self.temporal_buffers['features_buffer'][0, -1] = vision_output['hidden_state'][0, :]
      ...
      outputs = {**vision_output, **self.model_runner.run_policy()}
    else:
