...
from openpilot.iqpilot.selfdrive.iqmodeld.models.runners.constants import NumpyDict, ShapeDict, CLMemDict, FrameDict, Model, SliceDict, SEND_RAW_PRED
...
class ModelRunner(ModularRunner):
  ...
  def prepare_inputs(self, imgs_cl: CLMemDict, numpy_inputs: NumpyDict, frames: FrameDict) -> dict:
    ...
    :param imgs_cl: Dictionary of OpenCL memory slots for image inputs.
    :param numpy_inputs: Dictionary of numpy arrays for non-image inputs.
    :param frames: Dictionary of road projector objects for context.
