...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"IQBlinkerMinLateralSpeed", {PERSISTENT | BACKUP, INT, "20"}},  // MPH or km/h
    {"IQBlinkerPauseLateral", {PERSISTENT | BACKUP, INT, "0"}},
    ...
    {"IQDevUIInfo", {PERSISTENT | BACKUP, INT, "0"}},
    ...
    {"IQAlertSilence", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"IQLaneTurnDesire", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"IQLaneTurnValue", {PERSISTENT | BACKUP, FLOAT, "19.0"}},
    ...
    {"IQSpeedAssistMode", {PERSISTENT | BACKUP, INT, "1"}},
    {"IQSpeedAssistOffsetType", {PERSISTENT | BACKUP, INT, "0"}},
    {"IQSpeedAssistPolicy", {PERSISTENT | BACKUP, INT, "3"}},
    {"IQSpeedAssistValueOffset", {PERSISTENT | BACKUP, INT, "0"}},
