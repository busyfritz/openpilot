...
class NavWidget(Widget, abc.ABC):
  ...
  def covers_below(self) -> bool:
    # Full-screen opaque page: never draw the widgets underneath. The revealed page settles to
    # rest on pop (settle_to_top), so it appears in place instead of bouncing/sliding in.
    return True
