...
procs = [
  ...
  PythonProcess("iquploaderd", "iqpilot.konn3kt.uploaderd.iquploaderd", iquploaderd_ready),
...
procs += [
  # Models
  PythonProcess("models_manager", "iqpilot.selfdrive.iqmodeld.models.manager", only_offroad),
